#Western Scotian Shelf Model (Aggregated)
#SML
...
biomass <- c(0.407075, 0.049754, 0.04383, 0.00617, 0.0260249,0.023573, 4.082286,  
             4.240253, 0.137757, 6.294171, 0.878285, 0.173893, 0.458598, 1.818481,
             1.302563, 64.01978, 2, 7.345485, 42.75382, 0.5204, 41.31, 23.79555,
             5.800508, 3.678861, 33.664, 0.063293, 1, NA)
...
#Landings/Discards
land <- c(rep(0, 4), 0.00209077, 0.005067847, 0.3251713, 0.182276, 0.000799, 0.999061,
          0.019708, 0.001637, 0.220424, 0, 0.000162, 0.117151, 0.00236, 0, 0.03026,
          rep(0,8),NA)
disc <- c(0, 0.002995, 0, 2.4E-05, 0.000575, 0.000469, 0.013477, 0.002266, 0.013094,
          0.000487, 0.00056, 1.9E-05, 0.008776, 0.000633, 8E-06, 0, 4.1E-05, 0,
          0.019869, rep(0, 8), NA)
...
load(here('data-raw', 'DC.data.noscallop.RData'))
#-------------------------------------------
...
WSS28.params$pedigree[, 2:6] <- ped[, 3:7]

#export params
usethis::use_data(WSS28.params, overwrite = TRUE)
