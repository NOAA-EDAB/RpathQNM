...
for(j in seq_along(q.models)){
  ...
  while(i < n.sims) {
    ...
    # save(results, paste0("WSS28","results", j,"Phytoplankton_up",".RData"))
    write.csv(results, paste0("WSS28","results", j,"Phytoplankton_up",".csv"))
    ...
    filename= paste("WSS28", "plots", j,"Phytoplankton_up", ".pdf")
    pdf(filename)
