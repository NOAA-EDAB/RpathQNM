...
load("~/JCT work/WGNARS/RpathtoQNM/RpathQNM/data/all.results_noneut.rda")
...
all.results_noneut<-as.tibble(all.results_noneut)
...
jpeg(filename="RpathQNM_combined_plots_neut_mix_reordered_reum.jpeg", width=20, height=15, units="in", quality=100,res=600)
...
outd_QNM_10p<-outd_qnm_10%>% select ("Phytoplankton", "Small pelagics", "Seals", "Fishery") %>% summarize(across(Phytoplankton:Fishery, sum))
